...
namespace ShopBasket.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public ActionResult Index(string orderSearch, string startDate, string endDate, string orderSortOrder)
        {
            ...
            {
                orders = orders.Where(
                    o => o.OrderID.ToString().Equals(orderSearch) || o.UserID.Contains(orderSearch) || o.DeliveryName.Contains(orderSearch) ||
        ...
        public ActionResult Create([Bind(Include = "UserID,DeliveryName,DeliveryAddress")]
            Order order)
        {
